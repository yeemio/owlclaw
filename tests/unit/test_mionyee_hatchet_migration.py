"""Unit checks for mionyee migration dual-run replay outputs."""
...
def test_unit_dual_run_replay_all_jobs_match() -> None:
...
def test_unit_dual_run_replay_canary_batch_is_non_empty() -> None:
    jobs = load_jobs_from_mionyee_scenarios("config/e2e/scenarios/mionyee-tasks.json")
...
def test_unit_generated_hatchet_files_exist_for_first_batch() -> None:
