"""owlclaw db — init, migrate, status, revision, rollback, backup, restore (database CLI)."""
...
db_app = typer.Typer(
    name="db",
    help="Database operations: init, migrate, status, revision, rollback, backup, restore.",
)
