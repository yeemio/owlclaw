...
- [ ] 5. 实现 TemplateValidator 组件
  - [ ] 5.1 创建 TemplateValidator 类和模板验证
...
- [ ] 6. 实现 TemplateSearcher 组件
  - [ ] 6.1 创建 TemplateSearcher 类和搜索功能
...
- [ ] 8. 创建模板文件 - Monitoring 类别
  - [ ] 8.1 创建 health-check.md.j2 模板
...
- [ ] 13. 检查点 - 确保所有模板文件有效
  - 使用 TemplateValidator 验证所有 15 个模板文件
  - 确保所有模板包含有效的元数据注释块
  - 确保所有模板是有效的 Jinja2 模板
  - 如有问题请询问用户

- [ ] 14. 实现 CLI 集成 - owlclaw skill init 命令
  - [ ] 14.1 创建 CLI 命令入口
...
- [ ] 15. 实现 CLI 集成 - owlclaw skill validate 命令
  - [ ] 15.1 创建 validate 子命令
    - 实现 validate 子命令
...
- [ ] 16. 实现 CLI 集成 - owlclaw skill list 命令
  - [ ] 16.1 创建 list 子命令
    - 实现 list 子命令
...
- [ ] 20. 编写单元测试
  - [ ]* 20.1 为 TemplateRegistry 编写单元测试
    - 测试从目录加载模板
    - 测试通过 ID 获取模板
    - 测试列出和过滤模板
    - 测试搜索模板
  ...
  - [ ]* 20.2 为 TemplateRenderer 编写单元测试
    - 测试使用参数渲染模板
    - 测试缺少必需参数
    - 测试参数类型转换
    - 测试参数选项验证
  ...
  - [ ]* 20.3 为 TemplateValidator 编写单元测试
    - 测试验证有效的模板文件
    - 测试验证无效的模板文件
    - 测试验证有效的 SKILL.md 文件
    - 测试验证无效的 SKILL.md 文件
  ...
  - [ ]* 20.4 为 TemplateSearcher 编写单元测试
    - 测试关键词搜索
    - 测试类别过滤
    - 测试标签过滤
    - 测试组合过滤
