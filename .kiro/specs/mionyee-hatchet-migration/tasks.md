...
- [ ] 4.1 迁移有状态 Cron 任务（~10 个）
- [ ] 4.2 迁移链式任务（~8 个）
- [ ] 4.3 迁移剩余简单 Cron 任务（~25 个）
- [ ] 4.4 关闭 APScheduler，Hatchet 完全接管

## Task 5：验收

- [ ] 5.1 进程重启恢复测试：kill 进程后任务自动恢复
- [ ] 5.2 任务状态查询：通过 CLI 或 Dashboard 查看执行历史
- [ ] 5.3 回滚测试：切换环境变量后 APScheduler 恢复工作
- [ ] 5.4 端到端验收：48 个任务全部在 Hatchet 上正常运行
