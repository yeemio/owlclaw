...
- [x] 可以通过 `pip install owlclaw[langchain]` 安装
- [x] 可以注册 LangChain Runnable 为 capability
- [x] 可以调用注册的 Runnable
- [x] 输入 schema 验证正常工作
- [x] 输入输出转换正常工作
- [x] 执行记录到 Ledger
- [x] 执行受 Governance Layer 约束
- [x] 支持错误处理和 fallback
- [x] 支持重试机制
- [x] 支持与 Langfuse 集成
...
- [x] 类型检查通过（mypy）
- [x] 代码检查通过（ruff）
- [x] 文档完整（API 文档、用户指南、架构文档）

### 文档验收

- [x] API 文档完整（所有公开接口有文档字符串）
- [x] 用户指南完整（快速开始、配置、最佳实践、故障排查）
- [x] 架构文档完整（设计决策、数据流、错误处理）
- [x] 示例代码完整（至少 5 个典型场景）
- [x] 迁移指南完整
