...
- [x] 12. 集成到 LLM 客户端
  - [x] 12.1 修改 LLMClient 以支持 LLM 调用追踪
...
- [x] 13. 集成到工具执行系统
  - [x] 13.1 修改 ToolExecutor 以支持工具调用追踪
