...
- [x] 5.1 实现 Langfuse 初始化
  - [x] 5.1.1 从配置读取 Langfuse 参数
  - [x] 5.1.2 创建 Langfuse 客户端

- [x] 5.2 实现 Trace 记录
  - [x] 5.2.1 为每次 LLM 调用创建 trace
  - [x] 5.2.2 记录 input、output、tokens、cost
  - [x] 5.2.3 记录 function calls
...
- [x] 9.1 真实 API 调用测试
  - [x] 9.1.1 测试 OpenAI 调用
  - [x] 9.1.2 测试 Anthropic 调用
  - [x] 9.1.3 测试 function calling
...
- [x] 9.3 模型降级测试
  - [x] 9.3.1 模拟主模型失败
  - [x] 9.3.2 验证 fallback 执行

## Task 10: 文档和示例

- [x] 10.1 创建配置示例
  - [x] 10.1.1 创建 owlclaw.yaml 示例
  - [x] 10.1.2 添加配置说明注释

- [x] 10.2 创建使用示例
  - [x] 10.2.1 创建基本调用示例
  - [x] 10.2.2 创建 function calling 示例
  - [x] 10.2.3 创建模型路由示例

- [x] 10.3 更新 README
  - [x] 10.3.1 添加 LLM 集成说明
  - [x] 10.3.2 添加配置参考
