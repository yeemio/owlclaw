...
| **test-infra** | `.kiro/specs/test-infra/` | 🟡 三层齐全，进行中（5/11） | 测试基础设施统一（skip 机制 + unit 纯净化 + 共享 fixtures + 覆盖率分层 + CI 镜像对齐） |
