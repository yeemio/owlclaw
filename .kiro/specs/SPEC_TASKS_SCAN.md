...
| cli-scan | `.kiro/specs/cli-scan/` | 🟡 三层齐全，进行中（21/143） | AST 扫描器（Task 1/1.1/1.2/2/2.1~2.7/3/4/4.1~4.4/5/5.1~5.3 已完成） |
