...
| **mcp-capability-export** | `.kiro/specs/mcp-capability-export/` | 🟡 三层齐全，进行中（16/18） | MCP 能力输出（治理/持久任务/业务接入作为 MCP Server 暴露 + A2A Agent Card） |
...
|------|---|
| 最后更新 | 2026-02-27 |
| 当前批次 | review-work 审校循环：mionyee-governance-overlay 收口 + mcp-capability-export 持续推进 |
| 批次状态 | **进行中**。`mionyee-governance-overlay` 已完成 Task 0~4（14/14，已完成）；`mcp-capability-export` 已完成 Task 0/2/3/4/5（16/18），剩余 Task 1 与 Task 6。 |
