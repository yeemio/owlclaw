...
| integrations-langchain | `.kiro/specs/integrations-langchain/` | 🟡 三层齐全，进行中（51/101） | LangChain LLM 后端适配器 + 编排框架集成文档/示例 |
