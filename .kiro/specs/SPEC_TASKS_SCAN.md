...
| **openclaw-skill-pack** | `.kiro/specs/openclaw-skill-pack/` | 🟡 三层齐全，进行中（8/14） | OpenClaw Skill 包（owlclaw-for-openclaw 发布到 ClawHub） |
...
|------|---|
| 最后更新 | 2026-02-27 |
| 当前批次 | review-work 审校循环：mionyee-hatchet-migration 与 openclaw-skill-pack 并行推进 |
| 批次状态 | **进行中**。`mionyee-hatchet-migration` 已完成 Task 0/1/2/3.1/3.2/3.3（10/15）；`openclaw-skill-pack` 已完成 Task 0/1（8/14）；`mcp-capability-export` 已完成（18/18）。 |
| 已完成项 | 1) `mionyee-governance-overlay` 已完成（14/14）；2) `mcp-capability-export` 已完成（18/18）；3) `mionyee-hatchet-migration` 已完成任务盘点、迁移生成、双跑配置与回放一致性，新增 `scripts/mionyee_dual_run_replay.py` 与回放报告（all/canary 匹配率 100%）；4) `openclaw-skill-pack` 已完成契约对齐与基础技能包落地：`skills/owlclaw-for-openclaw/`（SKILL、README、config、示例与子技能说明）及 `tests/unit/test_openclaw_skill.py`。 |
| 下一待执行 | 1) `mionyee-hatchet-migration` Task 3.4/4/5：切换路径、扩批迁移、恢复/回滚/端到端验收；2) `openclaw-skill-pack` Task 2/3/4：OpenClaw 兼容验证、ClawHub 发布流程、教程复现；3) D14-1/D14-2/D14-3 实装。 |
| 验收快照 | quick-start ✅(13/13)，complete-workflow ✅(18/18)，architecture-roadmap ✅(13/13)，skill-dx ✅(25/25)，skill-ai-assist ✅(28/28)，progressive-migration ✅(31/31)，skills-quality ✅(27/27)，industry-skills ✅(12/12)，protocol-governance ✅(27/27)，contract-testing ✅(19/19)，gateway-runtime-ops ✅(18/18)，cross-lang-golden-path ✅(16/16)，protocol-first-api-mcp ✅(24/24)，test-infra ✅(11/11)，mionyee-governance-overlay ✅(14/14)，mcp-capability-export ✅(18/18)，mionyee-hatchet-migration 🟡(10/15)，openclaw-skill-pack 🟡(8/14)，release-supply-chain 🟡(11/15)，release 🟡(28/32，外部阻塞)，owlhub 🟡(141/143，仅 40/40.4 未完成)，Phase 8：content-launch 🟡(0/16)，Phase 8.5：D14-1 🟡(0/1)，D14-2 🟡(0/1)，D14-3 🟡(0/1)，其余 spec 全部 ✅。 |
