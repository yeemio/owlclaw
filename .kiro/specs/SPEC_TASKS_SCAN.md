...
| owlhub | `.kiro/specs/owlhub/` | 🟡 三层齐全，进行中（30/42） | OwlHub Skills 注册中心（Phase 1 GitHub 索引 → Phase 2 静态站点 → Phase 3 数据库） |
